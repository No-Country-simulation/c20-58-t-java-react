const NombreUsuario = (params) => {
  ...
  return (
    <>
      <div className="flex justify-start  items-center ml-4  h-14 bg-transparent w-[250px] border-2 borde-white rounded rounded-30  shadow-md shadow-white self-start mt-2">

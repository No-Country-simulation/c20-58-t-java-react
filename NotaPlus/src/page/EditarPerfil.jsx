          ...
          <div className="overflow-y-auto h-80 scrollbar-hide scroll-smooth  max-w-3xl w-full">
            ...
            <Titulos
             ...
             />
                ...
                <button type="submit" className="bg-palatinateBlue_Button w-[291px] h-[48px] rounded-lg py-[12px] px-[16px] my-8 text-white ease-in-out duration-300 hover:bg-mexicanPink_logo hover:scale-90 "><span>Guardar</span></button>

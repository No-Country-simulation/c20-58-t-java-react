...
const PoliticaPrivacidad = () => {
  ...
  return (
    ...
    <section className="flex flex-col place-content-center items-center mb-4">
        ...
        <div  className="flex max-w-3xl w-full flex-wrap p-6 items-center overflow-y-auto scrollbar-hide scroll-smooth gap-8 text-white bg-white/30 rounded-xl h-96 ">
          ...
          <ul className="list-disc list-inside pl-6 mb-3">
            ...
            <li className="text-[.9rem]">Información sobre el progreso académico</li>
          </ul>
          ...
          <ul className="list-disc list-inside pl-6 mb-3">
            <li className="text-[.9rem]">Gestionar el registro de estudiantes y su progreso académico</li>
            <li className="text-[.9rem]">Comunicación con padres y tutores legales</li>
            <li className="text-[.9rem]">Coordinación con profesores y administración escolar</li>
            <li className="text-[.9rem]">Cumplir con las normativas legales y educativas</li>
          </ul>
          ...
          <ul className="list-disc list-inside pl-6 mb-3">
            <li className="text-[.9rem]">Cuando es requerido por ley o para cumplir con procesos legales</li>
            <li className="text-[.9rem]">Con proveedores de servicios que nos ayudan a gestionar nuestra webapp, siempre garantizando la protección de la información</li>
            <li className="text-[.9rem]">En caso de emergencias para proteger la seguridad de los estudiantes o personal escolar</li>
          </ul>

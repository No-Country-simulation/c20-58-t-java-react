              ...
              <div className="overflow-x-auto scrollbar-hide"> 
                <table className="my-3 min-w-full bg-white">
                  <thead className="bg-pennBlue text-white"> 
                    <tr className="">
                      <th className="border border-gray-300 w-80 px-4 py-2">Sistema de Calificación</th>
                  ...
                  <tbody>
                      ...
                      <tr className="border-b hover:bg-gray-300">
                        ...
                        <td className=" border border-gray-300 px-4 py-2 text-center">1-10</td>
                      </tr>                
                  </tbody>
                </table>
                <table className="my-3 min-w-full bg-white">
                  <thead className="bg-pennBlue text-white"> 
                    <tr className="">
                      <th className=" border border-gray-300 w-80 px-4 py-2">Porcentaje para Aprobar</th>
                ...
                <table className="my-3 min-w-full bg-white">
                  <thead className="bg-pennBlue text-white"> 
                    <tr className="">
                      <th className=" border border-gray-300 w-80 px-4 py-2">Rango en Promedio</th>
                      <th className=" border border-gray-300 px-4 py-2">%</th>
                    </tr>
                  </thead>
                  <tbody>
                      ...
                      <tr className="border-b hover:bg-gray-300">
                        ...
                        <td className=" border border-gray-300 px-4 py-2 text-center">95-100</td>
                      </tr>  
                      <tr className="border-b hover:bg-gray-300">
                        <td className=" border border-gray-300 px-4 py-2  bg-blue-400">Sobresaliente</td>
                        <td className=" border border-gray-300 px-4 py-2 text-center">90-94</td>
                      </tr>   
                      <tr className="border-b hover:bg-gray-300">
                        <td className=" border border-gray-300 px-4 py-2  bg-yellow-500">Aprobado</td>
                        <td className=" border border-gray-300 px-4 py-2 text-center">93-60</td>
                      </tr>   
                      <tr className="border-b hover:bg-gray-300">
